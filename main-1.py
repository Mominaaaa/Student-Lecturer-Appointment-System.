...
def write_to_file(file1, file2, file3, _s, _l, _a):
    with open(file1, 'w', newline='') as file:
        ...
        for student in _s:  # Assuming _S is a list
    ...
    with open(file2, 'w', newline='') as file:
        writer = csv.writer(file)
        for lecturer in _l:  # Assuming _L is a list
...
def remove_appointment():
    ...
    # Remove only the matching appointment
...
listbox_students = tk.Listbox(root, width=70)  # Add width here
...
listbox_lecturers = tk.Listbox(root, width=60)  # Add width here
...
listbox_appointments = tk.Listbox(root, width=60)  # Add width here
